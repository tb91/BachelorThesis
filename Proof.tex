...
Furthermore, I assume that there are no four points in $U $ which are cocircular.
...
Since no four points are cocircular and $W $ is the angle maximizing node with respect to $CA $, the following is true: $\angle{CWA} > \angle{BCA} $.
