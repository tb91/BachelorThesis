...
Since $(O_1) $ is always contained completely in $O $, by precondition $\triangle{ABC} $ is empty and by lemma \ref{emptyregion} the region from $O_1 $ subtended by chord $CA $ away from B is empty, the circle $O_1 $ must be also empty. und AT ist frei wo o1 ist
