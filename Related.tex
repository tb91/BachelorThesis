...
\hline 
\end{tabular} 
\caption{Different topology controls ordered by appearance in this work.}
...
However, $G' $ is not a t-spanner of $G $ and has no constant node degree despite the underlying region ($GG, RNG, CNG $) (refer to figure \ref{fig:GG_CNG_RNG} for an example of these three regions).
