...
This algorithm would need less power to operate than the current state-of-the-art to construct the topology as well as while routing using that topology.
