...
\begin{itemize}
\item All nodes are static which means they cannot move.
...
The differences of the maximal neighbors for RMYS and PDT at high densities is explained in chapter \ref{discussion}.
...
Additionally, there are two cases where RMYS does not select all PDT neighbors of a node, even if the count of these neighbors is below the limit of $k=14 $.
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\linewidth]{eps/RMYS_case_one_cone_empty.eps}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.4\linewidth]{eps/PDT_linearer_Knotengrad.eps}
