...
%planarisierung tspanner etc erklären?
%reaktiv und lokal erklären?

\begin{frame}
Thema:\\
	Reaktive Konstruktion eines planaren t-Spanners mit konstantem Ausgangsgrad
\end{frame}
...
\end{itemize}
\end{frame}
%energieeffizient spanner nicht mit knotengradbeschränkung
\subsection{}
\begin{frame}
	\begin{itemize}
		\item $LDel^{(2)}(U) $
